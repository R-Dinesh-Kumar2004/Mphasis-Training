package app.management.book.utils;
...
public class DbUtils {
	...
	public static final String INSERT_BOOK = "INSERT INTO `spring_jdbc_demo`.`books` \r\n"
			...
			+ "  VALUES (?, ?, ?, ?, ?)";
	public static final String UPDATE_BOOK = "UPDATE `spring_jdbc_demo`.`books` SET book_name = :name, book_price = :price, no_of_copies = :copies, in_stock = :stock, date_of_publication = :date where book_id = :id";
	...
	public static final String GET_BOOK_BY_NAME = "SELECT * FROM `spring_jdbc_demo`.`books` WHERE book_name = ?";
}