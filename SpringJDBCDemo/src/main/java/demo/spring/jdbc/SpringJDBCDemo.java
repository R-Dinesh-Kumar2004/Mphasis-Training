...
//        	book.setStock(book.getNoOfCopies() > 0);
//        	
//        	boolean res = bookDao.modifyBook(book);
//        	
//        	System.out.println(res ? "Book updated " : "Book not updated");
//        	
//        }catch (Exception e) {
//			e.printStackTrace();
//		}
        ...
        //delete book
//        try {
//        	boolean isDeleted = bookDao.deleteBook(1);
//        	System.out.println(isDeleted ? "Book deleted " : "Book not deleted");
//        }catch (Exception e) {
//			e.printStackTrace();
//		}
